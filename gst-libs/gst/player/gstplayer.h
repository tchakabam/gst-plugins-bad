 ...
 * @GST_PLAYER_MESSAGE_STATE_CHANGED
 * @GST_PLAYER_MESSAGE_BUFFERING
 * @GST_PLAYER_MESSAGE_END_OF_STREAM
 * @GST_PLAYER_MESSAGE_ERROR
 * @GST_PLAYER_MESSAGE_WARNING
 * @GST_PLAYER_MESSAGE_VIDEO_DIMENSIONS_CHANGED
